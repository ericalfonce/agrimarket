...
# --------------------------------------------------
# Flask App Configuration (IMPORTANT FOR /eric PATH)
# --------------------------------------------------
app = Flask(
    __name__,
    static_url_path="/eric/static"   # ensures static files load correctly
)

app.secret_key = "supersecretkey"   # change in production

# tell Flask it is hosted under /eric
app.config["APPLICATION_ROOT"] = "/eric"
...
# --------------------------------------------------
# Run locally (not used in production with gunicorn)
# --------------------------------------------------
